...
function mockCoiRatePerThousand(sex, age) {
...
export function simulateUnitLinked(input) {
    const { age, sex, sumAssured, annualPremium, premiumTermYears, returnRate, months = 360, } = input;
...
export function summarizeYearly(input) {
